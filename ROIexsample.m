...
close all;
%Initilization
% path=('E:\cl\DIP\Pro2_15S158746_张常乐\testsample\G1');
% cd(path);
% dirs=dir;
% dircell=struct2cell(dirs)';
% filenames=dircell(3:52,1);
% for num=1:50
%     picname=char(filenames(num));
%     picsavename=['Seg' picname];
%     rgbimg=imread(picname);
    rgbimg=imread('E:\cl\DIP\Pro2_15S158746_张常乐\Pro2_15S158746_张常乐\Fruit Samples For Project2\澳洲蜜桔\澳洲蜜桔_image069.jpg');
